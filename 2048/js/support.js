...
function noBlokHorizontalRow(row, col1, col2, board) {
	for (var i = col1-1; i > col2; i--) {
		if (board[row][i] != 0) {
			return false;
		}
...
function noBlokDCol(row, col1, col2, board) {
	for (var i = col1+1; i < col2; i++) {
		if (board[i][row] != 0) {
			return false;
		}
...
function noBlokDRow(row, col1, col2, board) {
	for (var i = col1-1; i > col2; i--) {
		if (board[row][i] != 0) {
			return false;
		}
